                      ...
                      <li>
                        <a class="dropdown-toggle" data-toggle="dropdown">
                          ...
                          <div class="dropdown-menu">
                              <a class="dropdown-item" href="{{route('owner.showprofile')}}">My Profile</a>
                              <a class="dropdown-item" href="{{route('owner.logout')}}" onclick="showLogoutConfirmation();"><span>Log Out</span> <i class="fa fa-sign-out"></i></a>
                          </div>
                      </li>
                  </ul>
              </div>
